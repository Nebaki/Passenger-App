...
class SettingScreen extends StatelessWidget {
  ...
  void openTermsAndCondition(BuildContext context) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextButton(
                                ...
                                child: Text("Privacy Policy", style: _textStyle)),
                            TextButton(
                                onPressed: (){
                                  openTermsAndCondition(context);
                                },
                                child: Text("Terms & Conditions", style: _textStyle)),
                          ],
                        ),
                      ),
                    ],
...
Widget _menuItem({required BuildContext context,
